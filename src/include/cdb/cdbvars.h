 ...
 *	retrieve	The process acts as a simple database retrieving data from endpoint(cdbendpoint.c).
 *
...
typedef enum
{
	...
	GP_ROLE_RETRIEVE,			/* Operating as a simple database retrieving data from endpoint */
} GpRoleValue;
